...
$season->setNumber(4);
$season->setProgram($this->getReference('program_American Horror Story'));
$season->setDescription('Freak Show');
$season->setYear(2014);
...
$season->setNumber(8);
$season->setProgram($this->getReference('program_American Horror Story'));
$season->setDescription('Apocalypse');
$season->setYear(2018);
...
$season->setNumber(10);
$season->setProgram($this->getReference('program_American Horror Story'));
$season->setDescription('Double Feature');
$season->setYear(2020);
...
$season->setNumber(12);
$season->setProgram($this->getReference('program_American Horror Story'));
$season->setDescription('Delicate');
$season->setYear(2022);
